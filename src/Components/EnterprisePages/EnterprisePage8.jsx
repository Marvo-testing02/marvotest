...
import dottedLine from '../../assets/Ways/EightWay.svg';
import sideIllustration from '../../assets/illustrations/calling.svg';
import '../../App.css';

const EnterprisePage8 = ({goToNext}) => {
    ...
    return (
        ...
        >
            ...
            <Box sx={{ position: 'absolute', top: 43, left: 172, width: 1185, height: 124, zIndex: 5 }}>
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Would you like a product specialist to help with setup?
                        </Typography>

                        <RadioGroup value={clientType} onChange={(e) => setClientType(e.target.value)}>
                            {['Yes, Book Call', 'No, Continue Myself'].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
...
export default EnterprisePage8;
