...
const EnterprisePage5 = () => {
    ...
    return (
        ...
        >
            ...
            <motion.div
                initial={{ top: 90.86, left: 720.61 }}
                animate={{ top: 12, left: 882 }}
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Which outreach platform do you want to integrate?
                        </Typography>

                        <RadioGroup value={clientType} onChange={(e) => setClientType(e.target.value)}>
                            {['Whatsapp', 'Facebook', 'Instagram', 'Email', 'LinkedIn'].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
                        ...
                        {error && (
                            <Typography color="error" sx={{ color: 'red', mt: 1 }}>
...
export default EnterprisePage5;
