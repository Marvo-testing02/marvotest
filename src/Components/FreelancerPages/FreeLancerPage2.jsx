                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Which platforms do you use for outreach?
                        </Typography>
                        <RadioGroup value={goal} onChange={(e) => setGoal(e.target.value)}>
                            {['Email', 'LinkedIn', 'Instagram', 'Whatsapp', 'Other'].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
...
export default FreelancerPage2;
