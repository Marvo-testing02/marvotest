...
import sideIllustration from '../../assets/illustrations/generatingNewLeads.svg';
import '../../App.css';

const FreeLancerPage6 = () => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box sx={{ position: 'absolute', top: 102, left: 1081, width: 211, height: 111.22, zIndex: 5 }}>
                    <Box component="img" src={cloud} width="100%" />
                </Box>

                <Box sx={{ position: 'absolute', top: 120, left: 1150.63, width: 70, height: 76, transform: 'rotate(-25.43deg)', zIndex: 6 }}>
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Would you like to upload leads now?
                        </Typography>
                        <Typography mb={3} sx={{ fontFamily: 'Poppins, sans-serif', fontSize: 16 }}>
                            Leads to CSV upload screen
                        </Typography>
                        ...
                        {error && (
                            <Typography sx={{ color: 'red', mt: 1 }}>Please select an option before proceeding.</Typography>
                        )}
...
export default FreeLancerPage6;
