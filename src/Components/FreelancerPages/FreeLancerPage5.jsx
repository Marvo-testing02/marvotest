...
import sideIllustration from '../../assets/illustrations/templates.svg';
import '../../App.css';

const FreeLancerPage5 = () => {
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Would you like MARVO to generate mesage templates for you?
                        </Typography>
                        <Typography mb={3} sx={{ fontSize: 16 }}>
                            Triggers AI copywriting feature
                        </Typography>
...
export default FreeLancerPage5;
