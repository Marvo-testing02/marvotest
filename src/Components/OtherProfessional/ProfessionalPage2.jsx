...
import { Box, Typography, Radio, RadioGroup, FormControlLabel, Button, FormControl } from '@mui/material';
...
const ProfessionalPage2 = () => {
    ...
    const goToNextStep = () => {
        ...
        setError(false);
        navigate('/otherprofessional/page3');
    };
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            How do you mostly operate your business?
                        </Typography>
                        <FormControl error={error}>
                            <RadioGroup value={goal} onChange={(e) => setGoal(e.target.value)}>
                                {['Online only', 'Offline only', 'Both online and offline', 'Project-based', 'Event-based'].map((option, i) => (
                                    <FormControlLabel
                                        key={i}
                                        value={option}
                            ...
                            {error && <Typography sx={{ color: 'red', mt: 1 }} >Please select an option to proceed.</Typography>}
                        </FormControl>
...
export default ProfessionalPage2;
