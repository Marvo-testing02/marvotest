...
const ProfessionalPage4 = () => {
    ...
    const goToNextStep = () => {
        ...
        setError(false);
        navigate('/otherprofessional/page5');
    };
    ...
    return (
        ...
        >
            ...
            {[{ num: 5, x: 926, y: 30 }, { num: 6, x: 1158, y: 147 }]
                .map((step, i) => (
                    <Box
                        key={i}
                        sx={{
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Are you currently doing any marketing or promotions?
                        </Typography>

                        <RadioGroup value={clientType} onChange={(e) => setClientType(e.target.value)}>
                            {['Yes, running paid ads', 'Only organic social media promotion', 'Relying on referrals/word of mouth', 'Not doing any marketing yet', 'Planning to start soon'].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
...
export default ProfessionalPage4;
