                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Which platform do you actively use for your business?
                        </Typography>

                        <RadioGroup value={clientType} onChange={(e) => setClientType(e.target.value)}>
                            {['Instagram', 'Whatsapp', 'Your Website', 'Google Business Profile'].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
...
export default ProfessionalPage6;
