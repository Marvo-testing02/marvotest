...
const ChatBot = () => {
  ...
  return (
    <div className="fixed bottom-10 md:bottom-0 lg:bottom-0 right-4 md:right-0 z-50 lg:right-6 md:mb-[85px] md:mr-8">
      {/* Toggle Button */}
      <button
          ...
          >
            ...
            >
              <p className="text-[#1254DC] text-[16px] md:text-sm leading-[24px]">
                <strong className="text-[#1254DC] normal-case ">"Hey! I’m MARVO.</strong>
                <br />
