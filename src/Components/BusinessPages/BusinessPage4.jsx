...
import sideIllustration from '../../assets/illustrations/socialtree.svg';
import '../../App.css';

const BusinessPage4 = ({goToNext}) => {
    ...
    return (
        ...
        >
            ...
            <Box sx={{ position: 'absolute', top: 125, left: 350, width: 35, height: 35, borderRadius: '50%', backgroundColor: '#57AFFF', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: 16, zIndex: 7 }}>2</Box>
            <Box sx={{ position: 'absolute', top: 80, left: 550, width: 35, height: 35, borderRadius: '50%', backgroundColor: '#57AFFF', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', fontSize: 16, zIndex: 7 }}>3</Box>
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Which platforms do you want to connect first?
                        </Typography>

                        <RadioGroup value={clientType} onChange={(e) => setClientType(e.target.value)}>
                            {['Email', 'Linked In', 'Instagram', 'Whatsapp', 'Other'].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
