...
import dottedLine from '../../assets/Ways/SevenWay.svg';
import sideIllustration from '../../assets/illustrations/robot.svg';
import '../../App.css';

const BusinessPage7 = ({goToNext}) => {
                ...
                >
                    ...
                    >
                        <Typography variant="h4" fontWeight="bold" color="#1254DC" mb={3}>
                            Would you like to use pre-built automation workflows?
                        </Typography>

                        <RadioGroup value={clientType} onChange={(e) => setClientType(e.target.value)}>
                            {['Yes', 'Show me', "No, I'll build manually"].map((option, i) => (
                                <FormControlLabel
                                    key={i}
                                    value={option}
